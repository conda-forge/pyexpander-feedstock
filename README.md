...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyexpander-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8331&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyexpander-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyexpander` can be installed with:

```
conda install pyexpander
```

It is possible to list all of the versions of `pyexpander` available on your platform with:
